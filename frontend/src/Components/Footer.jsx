  ...
  return (
    <div className='relative bg-black w-full h-full md:h-140 lg:h-140 sm:h-full sm:w-full px-3'>
        ...
        <div className='flex flex-col sm:grid grid-cols-[2fr_2fr_2fr_3fr] text-white gap-14 my-10  mt-50 text-sm md:mx-8 mx-5'>
            ...
            <div className=' mt-10'>
                <p className='font-serif text-2xl tracking-tight mb-4 scale-y-130 font-extralight'>Shop</p>
            ...
            <div className=' mt-10'>
                <p className='font-serif text-2xl tracking-tighter mb-4 scale-y-130 font-extralight'>Company</p>
                <ul className='font-normal flex flex-col gap-2 text-xl'>
                    <li>About</li>
                    <li>Articles</li>
                </ul>
            ...
            <div className=' mt-10'>
                <p className='font-serif text-2xl tracking-tighter mb-4 scale-y-130 font-extralight'>Shop</p>
                <ul className='font-normal flex flex-col gap-2 text-xl'>
                    <li>FAQ</li>
                    <li>Contact Us</li>
                    <li>Return Policy</li>
            ...
            <div className=' mt-10'>
                <p className='font-serif text-3xl tracking-tighter font-extralight text-white mb-4 scale-y-130'>Be the first to discover <br />the latest news</p>
